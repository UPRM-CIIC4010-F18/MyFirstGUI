...
public class RacingFrog extends AbstractRaceable implements Raceable, Frog {
	...
	public RacingFrog(int xPosition, int yPosition) {
		this(xPosition, yPosition, DEFAULT_PIXELS_PER_TICK,DEFAULT_DIRECTION);
	}

	public RacingFrog(int xPosition, int yPosition, int speed) {
		this(xPosition, yPosition, speed, DEFAULT_DIRECTION);
	}

	public RacingFrog(int xPosition, int yPosition, int speed, int direction) {
